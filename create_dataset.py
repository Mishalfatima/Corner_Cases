...
# ------------------------ Load Data ------------------------
with open('val_GT_bboxes.pkl', 'rb') as f:
    data = pickle.load(f)
logging.info("Loaded bounding box data.")

in_path = '/ceph/mfatima/Inpainted_ImageNet_GT/test/'
images_path = '/ceph/mfatima/ImageNet/val/'
out_path = '/ceph/mfatima/Hard-Spurious-ImageNet-AR-Random_Corner/test/'
